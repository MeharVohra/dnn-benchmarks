...
if __name__ == '__main__':
    savefile = os.path.join(traindir, 'fp32_autoencoder_cifar10.pth')
    ...
    quant_model_path = os.path.join(traindir, 'int8Static_AE_cifar10.pth')
